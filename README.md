...
• Predict laptop prices with high accuracy using a trained ML model (`joblib`)
• User inputs include:
  - RAM
  - Weight
  - Screen type (Touchscreen/IPS)
  - Brand (Company)
  - Laptop Type (Gaming, Notebook, etc.)
  - Operating System
  - CPU & GPU brands
• Clean and simple UI built using Flask and Jinja templates
